...
export const api = {
  ...
  assignWorkOrderTechnicians: (id: string, input: { technicianIds: string[]; crewId?: string | null }) => apiFetch<WorkOrder>(`/work-orders/${id}/assignment`, { method: 'PATCH', ...json(input) }),
