...
const emptyForm = { name: '', contactName: '', email: '', phone: '', notes: '', status: 'ACTIVE' as const };
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      if (editingId) {
        ...
        await api.createCustomer({ ownerId, ...form });
      }
      setForm(emptyForm);
      setEditingId(null);
      await load();
    ...
    <>
      ...
      <div className="resourceGrid">
        ...
        <section className="panel">
          <div className="panelHeader"><h3>Customer list</h3><input className="searchInput" placeholder="Search customers" value={search} onChange={(e) => setSearch(e.target.value)} /></div>
