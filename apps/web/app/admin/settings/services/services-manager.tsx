  ...
  return <>
    ...
    <div className="resourceGrid">
      <form className="panel resourceForm" onSubmit={submit}>
        ...
        <label>Type<select value={form.type} onChange={(event) => setForm({ ...form, type: event.target.value as Service['type'] })}><option value="PRIMARY">Primary service</option><option value="ADD_ON">Add-on</option></select></label>
