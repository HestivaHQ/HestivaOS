...
export default async function AdminSettingsPage() {
  ...
  return <AppFrame active="/admin/settings" email={user.email} user={appUser}>
    ...
    <section className="adminSettingsGrid" aria-label="Administrative modules">
      ...
      <Link className="panel adminModuleLink" href="/employees#business-lists"><h3>Business Lists</h3><p>Manage Job Titles, Departments, and Property Types.</p><span className="statusPill">Manage business lists</span></Link>
