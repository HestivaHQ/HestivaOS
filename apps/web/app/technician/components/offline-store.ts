import type { StartJobOperation, TechnicianJob } from '../../../lib/api';
export type PendingStart = StartJobOperation & { workOrderId: string; kind: 'START_JOB'; queuedAt: string };
const DB = 'homent-technician'; const VERSION = 1;
...
export const pendingStarts = () => transaction<PendingStart[]>('operations','readonly',store=>store.getAll());
