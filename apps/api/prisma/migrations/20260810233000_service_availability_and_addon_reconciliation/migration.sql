-- Slice 5K reconciles current website capabilities without fabricating Work Order data.
-- BOTH represents one capability selectable as either the primary service or an add-on.
