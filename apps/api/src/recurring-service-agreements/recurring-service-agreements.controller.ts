...
import { AgreementInput, AgreementStatusInput, RecurringServiceAgreementsService } from './recurring-service-agreements.service';
...
export class RecurringServiceAgreementsController {
  ...
  @Patch(':id/status') status(@Param('id', new ParseUUIDPipe()) id: string, @Body() input: AgreementStatusInput) { return this.agreements.changeStatus(id, input); }
