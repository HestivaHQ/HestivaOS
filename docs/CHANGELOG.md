...
## 2026-08-19 — Technician completion corrections

- Added scoped ADMIN/SUPERVISOR correction authorization and assigned-Technician offline resubmission over append-only outcome history.
- Prior completion and acknowledgement facts remain recorded; an actual correction makes acknowledgement non-current and requires fresh management acknowledgement. No Finance or correspondence delivery was added.
