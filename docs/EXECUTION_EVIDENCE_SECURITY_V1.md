...
Post-completion correction/reopen is subsequently governed by `TECHNICIAN_COMPLETION_CORRECTIONS_V1.md`: original evidence and completion history remain immutable, and new evidence is additive.
