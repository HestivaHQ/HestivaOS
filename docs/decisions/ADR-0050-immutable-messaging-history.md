# ADR-0050: Keep persisted messaging history immutable
...
This decision does not require keeping raw provider webhook payloads. ADR-0049 remains authoritative that HestivaOS persists normalized provider data rather than complete Meta payload JSON.
