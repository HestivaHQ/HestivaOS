...
| Messaging / WhatsApp / Messenger | `MESSAGING_FOUNDATION_V1.md`, `MESSAGING_QUOTE_STATE_V1.md`, `MESSAGING_WHATSAPP_QUOTE_FLOW_V1.md`, `contracts/HOMENT_QUOTE_REQUEST_V1.json`, `contracts/HOMENT_QUOTE_REQUEST_V1_FIXTURES.json` | messaging modules/adapters | ADR-0048–0052, ADR-0078–0084, ADR-0088; Issue #116 |
