...
| Messaging / WhatsApp / Messenger | messaging foundation/current messaging contract docs | messaging modules/adapters | ADR-0048–0052 and later relevant messaging ADRs; Issue #116 |
